...
export class PaymentListComponent implements OnInit {
  ...
  columnDefs: ColDef<Payment>[] = [
    ...
    // { headerName: 'ID Cliente', field: 'idClient', sortable: true, filter: true,},
  ...
  renderFile(payment: Payment): void {
    this.router.navigate(['/files/entity', 'payment', payment.idPayment]);
  }
